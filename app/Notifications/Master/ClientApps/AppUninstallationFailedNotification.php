...
class AppUninstallationFailedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return 'AppUninstallationFailed';
    }
    ...
    public function toMail($notifiable)
    {
        ...
        $mail = (new MailMessage)
            ->subject("Error occurred while uninstalling $app_name")
            ->greeting("Dear, " . $notifiable->name)
            ->line("We are sorry to inform you that the attempt to uninstall $app_name app for the client \"$client_name\" was unsuccessful.")
            ...
            ->line('Try to do some changes to client settings and re-uninstall the app.')
