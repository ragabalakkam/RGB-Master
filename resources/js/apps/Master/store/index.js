...
const modules = {
  ...
  locations: require("../../../common/modules/locations.js").default,
  ...
  // 
  sounds: require("../../../common/modules/sounds.js").default,
  alerts: require("../../../common/modules/alerts.js").default,
  // 
  modules: require("./modules/api_modules.js").default,
  employees: require("./modules/employees.js").default,
  permissions: require("./modules/permissions.js").default,
  clients: require("./modules/clients.js").default,
  versions: require("./modules/versions.js").default,
  business_types: require("./modules/business_types.js").default,
  apps: require("./modules/apps.js").default,
};
