...
const modules = {
  admin: require("../../../common/modules/admin.js").default,
  ...
  client: require('../../Client/store/modules/client.js').default,
  business_types: require('../../Master/store/modules/business_types.js').default,
};
